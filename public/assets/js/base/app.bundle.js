...
$(() => {
    ...
    let li = $('li[data-active=1]');
    li.addClass('kt-menu__item--active');
    li.parents('.kt-menu__item--submenu').addClass('kt-menu__item--open');

    let link = $('a[data-active=1]');

    link.parent().addClass('kt-menu__item--active');
    link.parents('.kt-menu__submenu').parents('.kt-menu__item').addClass('kt-menu__item--open');
});
