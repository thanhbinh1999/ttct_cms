...
/***/ "./platform/ttct/resources/assets/js/pages/reserve-paper-index.js":
/*!************************************************************************!*\
  !*** ./platform/ttct/resources/assets/js/pages/reserve-paper-index.js ***!
  \************************************************************************/
/*! no exports provided */
...
var ReservePaperIndex =
/*#__PURE__*/
function () {
  function ReservePaperIndex() {
    _classCallCheck(this, ReservePaperIndex);
  ...
  _createClass(ReservePaperIndex, [{
    key: "init",
    value: function init() {
      this.initGetAcl();
      this.initPublish();
    ...
    value: function initGetAcl() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get($('body').data('acl')).then(function (res) {
        _this.acl = res.data;
    ...
    value: function initDatatable() {
      ...
      this.datatable = this.$reservePaperTable.KTDatatable({
        ...
        columns: [{
          ...
          textAlign: 'center',
          template: function template(row) {
            return "<img style=\"width: 150px\" class=\"img-thumbnail\" src=\"".concat(row.thumbnail.base_url, "/").concat(row.thumbnail.absolute_url, "\">");
          }
        }, {
          field: 'status',
          title: 'TRẠNG THÁI',
          ...
          template: function template(row) {
            if (_this2.acl) {
              var html = '';
              var permissions = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["checkPermissions"])(['reserve-paper-delete', 'reserve-paper-update', 'reserve-paper-restore', 'reserve-paper-publish', 'reserve-paper-take-down'], _this2.acl.permissions);

              var urlEdit = _this2.$reservePaperTable.data('edit');

              urlEdit = urlEdit.slice(0, urlEdit.lastIndexOf('/') + 1) + row.id;
              var edit = permissions['reserve-paper-update'] ? "<a class=\"dropdown-item edit font-weight-bold\" href=\"".concat(urlEdit, "\"><i class=\"la la-edit\"></i> C\u1EADp nh\u1EADt</a>") : '';
              var pub = permissions['reserve-paper-publish'] && row.url_publish ? "<a class=\"dropdown-item publish font-weight-bold\" href=\"#\" data-url=\"".concat(row.url_publish, "\" data-status=\"").concat(row.status_publish, "\"><i class=\"la la-upload\"></i> Xu\u1EA5t b\u1EA3n</a>") : '';
              var del = permissions['reserve-paper-delete'] && row.url_delete ? "<a class=\"dropdown-item delete font-weight-bold\" href=\"#\" data-url=\"".concat(row.url_delete, "\" data-status=\"").concat(row.status_delete, "\"><i class=\"la la-close\"></i> X\xF3a</a>") : '';
              var tkd = permissions['reserve-paper-take-down'] && row.url_take_down ? "<a class=\"dropdown-item take-down font-weight-bold\" href=\"#\" data-url=\"".concat(row.url_take_down, "\" data-status=\"").concat(row.status_take_down, "\"><i class=\"la la-arrow-down\"></i> G\u1EE1 xu\u1ED1ng</a>") : '';
              var restore = permissions['reserve-paper-restore'] && row.url_restore ? "<a class=\"dropdown-item restore font-weight-bold\" href=\"#\" data-url=\"".concat(row.url_restore, "\" data-status=\"").concat(row.status_restore, "\"><i class=\"la la-undo\"></i> Kh\xF4i ph\u1EE5c</a>") : '';
...
/***/ 13:
/*!******************************************************************************!*\
  !*** multi ./platform/ttct/resources/assets/js/pages/reserve-paper-index.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/ttct_cms/platform/ttct/resources/assets/js/pages/reserve-paper-index.js */"./platform/ttct/resources/assets/js/pages/reserve-paper-index.js");
