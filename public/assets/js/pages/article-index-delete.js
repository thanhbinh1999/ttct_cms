...
/***/ "./platform/ttct/resources/assets/js/pages/article-index-delete.js":
/*!*************************************************************************!*\
  !*** ./platform/ttct/resources/assets/js/pages/article-index-delete.js ***!
  \*************************************************************************/
/*! no exports provided */
...
var ArticleIndexDelete =
/*#__PURE__*/
function () {
  function ArticleIndexDelete() {
    _classCallCheck(this, ArticleIndexDelete);
  ...
  _createClass(ArticleIndexDelete, [{
    key: "init",
    value: function init() {
      this.initGetAcl();
      this.initRestore();
    ...
    value: function initDatatable() {
      ...
      this.datatable = this.$articleTable.KTDatatable({
        ...
        columns: [{
          ...
          template: function template(row) {
            if (_this2.acl) {
              var permissions = Object(_helper__WEBPACK_IMPORTED_MODULE_1__["checkPermissions"])(['article-update', 'article-publish', 'article-restore', 'article-take-down'], _this2.acl.permissions);

              var editUrl = _this2.$articleTable.data('edit');

              editUrl = editUrl.slice(0, editUrl.lastIndexOf('/') + 1) + row.id;
              var re = permissions['article-restore'] ? "<a class=\"dropdown-item restore\" href=\"#\" data-status=\"".concat(row.status_restore, "\" data-restore=\"").concat(row.url_restore, "\"><i class=\"la la-undo\"></i> Kh\xF4i ph\u1EE5c</a>") : '';
              var edit = permissions['article-update'] ? "<a class=\"dropdown-item edit\" href=\"".concat(editUrl, "\"><i class=\"la la-edit\"></i> C\u1EADp nh\u1EADt</a>") : '';
        ...
        swal.fire({
          ...
          if (result.value) {
            axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, {
              status: status,
              from_user: _this3.$userInfo.data('id'),
              from_user_full_name: _this3.$userInfo.data('full-name'),
              from_user_username: _this3.$userInfo.data('username')
            }).then(function (res) {
...
/***/ 4:
/*!*******************************************************************************!*\
  !*** multi ./platform/ttct/resources/assets/js/pages/article-index-delete.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/ttct_cms/platform/ttct/resources/assets/js/pages/article-index-delete.js */"./platform/ttct/resources/assets/js/pages/article-index-delete.js");
