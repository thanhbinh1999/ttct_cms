...
/***/ "./platform/user/resources/assets/js/pages/users-create.js":
/*!*****************************************************************!*\
  !*** ./platform/user/resources/assets/js/pages/users-create.js ***!
  \*****************************************************************/
/*! no exports provided */
...
function () {
  ...
  _createClass(UsersCreate, [{
    ...
    value: function initSelect2() {
      ...
      this.$role.change(function () {
        Object(_ttct_resources_assets_js_pages_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])(_this.$role);
      });
    }
  }, {
    key: "initPickDate",
    ...
    value: function initSubmit() {
      ...
      this.$formCreateUser.submit(function (event) {
        event.preventDefault(); // showBlock();

        Object(_ttct_resources_assets_js_pages_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])([_this2.$firstName, _this2.$lastName, _this2.$email, _this2.$username, _this2.$dob, _this2.$phone, _this2.$address, _this2.$gender, _this2.$role, _this2.$password, _this2.$passwordConfirmation, _this2.$avatar]);
        var url = $(event.target).attr('action');
        var fd = new FormData(event.target);
        var role = _this2.$role.select2('data').length > 0 ? _this2.$role.select2('data')[0].id : null;
        fd.append('role', role);
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, fd).then(function (_ref) {
          ...
          if (status === 422) {
            Object(_ttct_resources_assets_js_pages_helper__WEBPACK_IMPORTED_MODULE_1__["showError"])('', err.response.data.errors);
          } else {
...
/***/ 31:
/*!***********************************************************************!*\
  !*** multi ./platform/user/resources/assets/js/pages/users-create.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/cms/platform/user/resources/assets/js/pages/users-create.js */"./platform/user/resources/assets/js/pages/users-create.js");
