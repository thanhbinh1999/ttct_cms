...
/***/ "./platform/comment/resources/assets/js/pages/comment/comment-report-most-comment.js":
/*!*******************************************************************************************!*\
  !*** ./platform/comment/resources/assets/js/pages/comment/comment-report-most-comment.js ***!
  \*******************************************************************************************/
...
/**
 * @author       Giang Nguyen
 * @description class CommentReportMostComment
 */
var CommentReportMostComment =
/*#__PURE__*/
function () {
  function CommentReportMostComment() {
    _classCallCheck(this, CommentReportMostComment);

    this.$commentReportMostCommentTable = $('#comment-report-most-comment-table');
    this.datatable = null;
  ...
  _createClass(CommentReportMostComment, [{
    key: "init",
    value: function init() {
      this.initSelect2();
      this.initPickDate();
    ...
    value: function initDatatable() {
      ...
      this.datatable = this.datatable = this.$commentReportMostCommentTable.KTDatatable({
        data: {
          type: 'remote',
          source: {
            read: {
              url: this.$commentReportMostCommentTable.data('url'),
              headers: {
        ...
        columns: [{
          ...
          textAlign: 'center',
          template: function template(row) {
            return "<strong>".concat(row.total, "</strong>");
          }
        }]
      });
  ...
  return CommentReportMostComment;
}();

$(function () {
  new CommentReportMostComment();
});
...
/***/ 45:
/*!*************************************************************************************************!*\
  !*** multi ./platform/comment/resources/assets/js/pages/comment/comment-report-most-comment.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/cms/platform/comment/resources/assets/js/pages/comment/comment-report-most-comment.js */"./platform/comment/resources/assets/js/pages/comment/comment-report-most-comment.js");
