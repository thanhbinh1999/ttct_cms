...
/***/ "./platform/rbac/resources/assets/js/pages/permission-index.js":
/*!*********************************************************************!*\
  !*** ./platform/rbac/resources/assets/js/pages/permission-index.js ***!
  \*********************************************************************/
/*! no exports provided */
...
function () {
  function PermissionIndex() {
    _classCallCheck(this, PermissionIndex);

    this.$searchKey = $('#search-key');
    this.$permissionTable = $('#permission-table');
    this.datatable = null; // update
    ...
    this.editPermisison = null; //create
  ...
  _createClass(PermissionIndex, [{
    ...
    value: function initDatatable() {
      ...
      this.datatable = this.$permissionTable.KTDatatable({
        ...
        columns: [{
          ...
          template: function template(row) {
            if (_this.acl) {
              var permissions = Object(_ttct_resources_assets_js_pages_helper__WEBPACK_IMPORTED_MODULE_1__["checkPermissions"])(['permission-update', 'permission-delete', 'permission-restore'], _this.acl.permissions);
              var reOrDel = row.url_restore ? permissions['permission-restore'] ? "<a class=\"dropdown-item restore\" href=\"#\" data-id=\"".concat(row.id, "\"  data-restore=\"").concat(row.url_restore, "\"><i class=\"la la-undo\"></i> Kh\xF4i ph\u1EE5c</a>") : '' : permissions['permission-delete'] ? "<a class=\"dropdown-item delete\" href=\"#\" data-delete=\"".concat(row.url_delete, "\"><i class=\"la la-trash\"></i> X\xF3a</a>") : '';
              var edit = permissions['permission-update'] ? "<a class=\"dropdown-item\" href=\"#\" data-edit=\"".concat(row.url_get_data_edit, "\" data-toggle=\"modal\" data-target=\"#modal-edit-permission\"><i class=\"la la-edit\"></i> C\u1EADp nh\u1EADt</a>") : '';
    ...
    value: function initModal() {
      ...
      this.$modalCreatePermission.on('hide.bs.modal', function () {
        _this2.$formCreatePermission.trigger('reset');

        Object(_ttct_resources_assets_js_pages_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])([_this2.$createName]);
      });
      this.$modalEditPermission.on('show.bs.modal', function (event) {
        var url = $(event.relatedTarget).data('edit');
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url).then(function (_ref) {
          var data = _ref.data;
          _this2.editPermisison = data;

          _this2.$updateName.val(data.name);

          _this2.$updateDescription.val(data.description);
        }, function (err) {
        ...
        _this2.$formUpdatePermission.trigger('reset');

        Object(_ttct_resources_assets_js_pages_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])([_this2.$updateName]);
      });
    }
  }, {
    key: "initCreate",
    value: function initCreate() {
      ...
      this.$formCreatePermission.submit(function (event) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, new FormData(event.target)).then(function (_ref2) {
          ...
          if (data && data.message) {
            ...
            _this3.$modalCreatePermission.modal('hide');
          }
        }, function (err) {
          var status = err.response.status;
    ...
    value: function initUpdate() {
      ...
      this.$formUpdatePermission.submit(function (event) {
        event.preventDefault();

        if (_this4.editPermisison) {
          var url = _this4.editPermisison.update_url;
          axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, new FormData(event.target)).then(function (_ref3) {
            ...
            if (data.message) {
              ...
              _this4.$modalEditPermission.modal('hide');
            }
          }, function (err) {
            var status = err.response.status;
...
/***/ 29:
/*!***************************************************************************!*\
  !*** multi ./platform/rbac/resources/assets/js/pages/permission-index.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/cms/platform/rbac/resources/assets/js/pages/permission-index.js */"./platform/rbac/resources/assets/js/pages/permission-index.js");
