...
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helper */ "./platform/ttct/resources/assets/js/pages/helper.js");
...
/* harmony default export */ __webpack_exports__["default"] = (ArticleCreateUpdateCreateTag);
...
/* harmony default export */ __webpack_exports__["default"] = (ArticleCreateUpdateCreateTheme);
...
/***/ "./platform/ttct/resources/assets/js/pages/reserve-paper-edit.js":
/*!***********************************************************************!*\
  !*** ./platform/ttct/resources/assets/js/pages/reserve-paper-edit.js ***!
  \***********************************************************************/
/*! no exports provided */
...
/* harmony import */ var _article_create_update_create_tag__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./article-create-update-create-tag */ "./platform/ttct/resources/assets/js/pages/article-create-update-create-tag.js");
/* harmony import */ var _article_create_update_create_theme__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./article-create-update-create-theme */ "./platform/ttct/resources/assets/js/pages/article-create-update-create-theme.js");
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block */ "./platform/ttct/resources/assets/js/pages/block.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ReservePaperEdit =
/*#__PURE__*/
function () {
  function ReservePaperEdit() {
    _classCallCheck(this, ReservePaperEdit);
  ...
  _createClass(ReservePaperEdit, [{
    ...
    value: function initThumbnail() {
      ...
      this.$selectThumbnail.click(function (event) {
        ...
        _this2.selectResourceIsCurrentUseFor = 'thumbnail';
      });
      this.$thumbnail.click(function (event) {
        event.preventDefault();

        _this2.$selectThumbnail.click();
      });
    }
  }, {
    key: "initCover",
    value: function initCover() {
      ...
      this.$selectCoverPc.click(function (event) {
        event.preventDefault();
        _this3.fileMode = 'image';
        _this3.selectResourceIsCurrentUseFor = 'cover-pc';
      });
      this.$updateCoverPc.click(function (event) {
        event.preventDefault();

        _this3.$selectCoverPc.click();
      });
      ...
      this.$selectCoverMobile.click(function (event) {
        event.preventDefault();
        _this3.fileMode = 'image';
        _this3.selectResourceIsCurrentUseFor = 'cover-mobile';
      });
      this.$updateCoverMoblie.click(function (event) {
        event.preventDefault();

        _this3.$selectCoverMobile.click();
      });
    }
  }, {
    key: "initPreview",
    value: function initPreview() {
      ...
      this.$articlePreviewBtn.click(function (event) {
        ...
        _this4.setLocalStorageData();

        if (_this4.window) {
          _this4.window.location.reload();
        } else {
          _this4.window = window.open(url, '_blank');

          _this4.window.onbeforeunload = function () {
            _this4.window = null;
    ...
    value: function initSelectBlock() {
      ...
      this.$selectBlock.click(function () {
        ...
        $(positionMark).remove(); // this.editor.html.insert(html);
    ...
    value: function initFroalaEditor() {
      ...
      FroalaEditor.RegisterCommand('modalBrowseImage', {
        ...
        callback: function callback() {
          _this5.selectResourceIsCurrentUseFor = 'froala';
          _this5.fileMode = 'image';

          _this5.$modalSelectResource.modal('show');
        }
      });
      ...
      FroalaEditor.RegisterCommand('modalSelectBlockHtml', {
        ...
        refreshAfterCallback: false,
        callback: function callback() {
          _this5.editor.html.insert('<div id="position_mark"></div>');

          _this5.$modalSelectBlock.modal('show');
        }
      });
    ...
    value: function initSelect2() {
      ...
      this.$categories.on('select2:select', function () {
        var formGroup = _this6.$categories.parent();

        formGroup.find('.invalid-feedback').remove();

        _this6.$categories.removeClass('is-invalid');
      ...
      this.$tags.on('select2:select', function () {
        var formGroup = _this6.$tags.parent();

        formGroup.find('.invalid-feedback').remove();

        _this6.$tags.removeClass('is-invalid');
      ...
      this.$themes.on('select2:select', function () {
        var formGroup = _this6.$themes.parent();

        formGroup.find('.invalid-feedback').remove();

        _this6.$themes.removeClass('is-invalid');
    ...
    value: function initGetData() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get($('#kt_content').data('edit')).then(function (_ref) {
        var data = _ref.data;

        if (data.id) {
          var permissions = Object(_helper__WEBPACK_IMPORTED_MODULE_1__["checkPermissions"])(['reserve-paper-update'], _this7.acl.permissions);
          _this7.data = data;
          _this7.thumb = data.thumbnail;

          _this7.$title.val(data.title);

          _this7.$excerpt.val(data.excerpt);

          _this7.$author.val(data.author);
          ...
          data.metas.forEach(function (meta) {
            switch (meta.key) {
              case 'google-description':
                {
                  _this7.$updateGoogleDescription.val(meta.value);
              ...
              case 'google-key':
                {
                  _this7.$uploadGoogleKey.val(meta.value);
              ...
              case 'fb-description':
                {
                  _this7.$uploadFbDescription.val(meta.value);
              ...
              case 'fb-title':
                {
                  _this7.$uploadFbTitle.val(meta.value);
              ...
              case 'off_title':
                {
                  parseInt(meta.value) === 2 && _this7.$offTitle.prop('checked', true).trigger('change');
                  break;
                }

              case 'off_thumb_pc':
                {
                  parseInt(meta.value) === 2 && _this7.$offThumbPc.prop('checked', true).trigger('change');
                  break;
                }

              case 'off_thumb_mobile':
                {
                  parseInt(meta.value) === 2 && _this7.$offThumbMobile.prop('checked', true).trigger('change');
                  break;
                }

              case 'off_description':
                {
                  parseInt(meta.value) === 2 && _this7.$offDescription.prop('checked', true).trigger('change');
                  break;
                }
            }
          });

          var thumb = _this7.dropifyThumbail.data('dropify');
          ...
          if (data.cover_p_c) {
            _this7.coverPC = data.cover_p_c;

            var coverPC = _this7.dropifyCoverPC.data('dropify');
          ...
          if (data.cover_mobile) {
            _this7.coverMobile = data.cover_mobile;

            var coverMobile = _this7.dropifyCoverMobile.data('dropify');
          ...
          _this7.$categories.append(new Option('TTCT- Kỳ báo', 'reserve-paper')).trigger('change');

          var valueTag = data.tags.map(function (tag) {
            var option = new Option(tag.name, tag.id);

            _this7.$tags.append(option);

            return tag.id;
          });

          _this7.$tags.val(valueTag).trigger('change');

          var themes = data.themes;
          var valueTheme = themes.map(function (theme) {
            var option = new Option(theme.name, theme.id);

            _this7.$themes.append(option);

            return theme.id;
          });

          _this7.$themes.val(valueTheme).trigger('change');

          if (permissions['reserve-paper-update'] && parseInt(data.status) === 1) {
            _this7.$btnPublish.show();
          }

          _this7.initEditor(_this7.data.content);
          ...
          _this7.$themes.prop('disabled', true);

          _this7.$tags.prop('disabled', true);

          _this7.$articlePreviewBtn.prop('disabled', true);

          _this7.$btnSubmit.prop('disabled', true);
        }
      }, function (err) {
        Object(_helper__WEBPACK_IMPORTED_MODULE_1__["hideBlock"])();
        ...
        _this7.$modalUploadResourceBtnUpload.remove();
    ...
    value: function initSubmit() {
      ...
      this.$btnSubmit.click(function (event) {
        ...
        var fd = _this8.generateFormData();
    ...
    value: function initPublish() {
      ...
      this.$btnPublish.click(function (event) {
        event.preventDefault();
        Object(_helper__WEBPACK_IMPORTED_MODULE_1__["showBlock"])();
        var urlUpdateStatus = _this9.data.url_publish ? _this9.data.url_publish : '';

        var urlUpdate = _this9.$btnSubmit.data('update');

        var status = _this9.data.status_publish ? _this9.data.status_publish : 0;

        var fd = _this9.generateFormData();

        if (urlUpdateStatus !== '') {
          axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(urlUpdate, fd).then(function (res) {
            axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(urlUpdateStatus, {
              status: status
            }).then(function (res) {
              if (res.data && res.data.message) {
                window.onbeforeunload = null;
  ...
  return ReservePaperEdit;
}();

$(function () {
  var reservePaperEdit = new ReservePaperEdit();
  new _article_create_upload_resource__WEBPACK_IMPORTED_MODULE_2__["default"](reservePaperEdit);
  new _article_create_update_create_tag__WEBPACK_IMPORTED_MODULE_3__["default"](reservePaperEdit.$tags);
  new _article_create_update_create_theme__WEBPACK_IMPORTED_MODULE_4__["default"](reservePaperEdit.$themes);
});
...
/***/ 14:
/*!*****************************************************************************!*\
  !*** multi ./platform/ttct/resources/assets/js/pages/reserve-paper-edit.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/ttct_cms/platform/ttct/resources/assets/js/pages/reserve-paper-edit.js */"./platform/ttct/resources/assets/js/pages/reserve-paper-edit.js");
