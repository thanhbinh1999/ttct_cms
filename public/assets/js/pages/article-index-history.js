...
/***/ "./platform/ttct/resources/assets/js/pages/article-index-history.js":
/*!**************************************************************************!*\
  !*** ./platform/ttct/resources/assets/js/pages/article-index-history.js ***!
  \**************************************************************************/
/*! no exports provided */
...
var ArticleIndexHistory =
/*#__PURE__*/
function () {
  function ArticleIndexHistory() {
    _classCallCheck(this, ArticleIndexHistory);
  ...
  _createClass(ArticleIndexHistory, [{
    key: "init",
    value: function init() {
      this.initGetAcl();
      this.cancelInit();
    ...
    value: function initDatatable() {
      ...
      this.datatable = this.$articleTable.KTDatatable({
          ...
          source: {
            read: {
              ...
              params: {
                ...
                }), _defineProperty(_query, "from_user", function from_user() {
        ...
        columns: [{
          ...
          textAlign: 'left',
          template: function template(row) {
            return row.feed_back ? "<p style=\"font-size: 15px;color: black\">".concat(row.feed_back, "</p>") : 'N/A';
          }
        }, {
          field: 'from_user',
          title: 'NGƯỜI GỬI',
          ...
          template: function template(row) {
            if (_this2.acl) {
              ...
              var cancel = parseInt(row.status) === 2 && row.url_cancel && parseInt(row.sb_or_fw) === 1 ? "<a class=\"dropdown-item cancel font-weight-bold\" href=\"#\" data-prev-transfer=\"".concat(row.prev_transfer, "\" data-cancel=\"").concat(row.url_cancel, "\"><i class=\"la la-edit\"></i> H\u1EE7y chuy\u1EC3n b\xE0i</a>") : '';
    ...
    value: function cancelInit() {
      ...
      $(document).on('click', '.cancel', function (event) {
        ...
        var url = $(event.currentTarget).data('cancel');
        var prevTransfer = $(event.currentTarget).data('prev-transfer');
        swal.fire({
          title: 'Xác nhận hủy',
...
/***/ 6:
/*!********************************************************************************!*\
  !*** multi ./platform/ttct/resources/assets/js/pages/article-index-history.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/ttct_cms/platform/ttct/resources/assets/js/pages/article-index-history.js */"./platform/ttct/resources/assets/js/pages/article-index-history.js");
