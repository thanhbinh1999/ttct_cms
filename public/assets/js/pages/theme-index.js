...
/***/ "./platform/ttct/resources/assets/js/pages/theme-index.js":
/*!****************************************************************!*\
  !*** ./platform/ttct/resources/assets/js/pages/theme-index.js ***!
  \****************************************************************/
/*! no exports provided */
...
function () {
  function ThemeIndex() {
    ...
    this.$createThumbnail = $('#create-thumbnail'); // update
  ...
  _createClass(ThemeIndex, [{
      ...
      this.datatable = this.$themeTable.KTDatatable({
          ...
          source: {
            read: {
              ...
              params: {
                ...
                }), _defineProperty(_query, "type", 2), _query)
              },
        ...
        columns: [{
          ...
          template: function template(row) {
            return "<strong>".concat(row.id, "</strong>");
          }
        }, {
          field: 'name',
          title: 'TÊN',
          ...
          textAlign: 'center',
          template: function template(row) {
            return row.thumbnail ? "<img class=\"img-thumbnail\" style=\"width: 100%\" src=\"".concat(row.thumbnail.base_url, "/").concat(row.thumbnail.absolute_url, "\">") : 'N/A';
          }
        }, {
          field: 'description',
          title: 'MÔ TẢ',
          ...
          textAlign: 'left',
          template: function template(row) {
            return "<div style=\"color: black\">".concat(row.description ? row.description : 'N/A', "</div>");
          }
        }, {
          field: 'status',
          title: 'TRẠNG THÁI',
          ...
          template: function template(row) {
            if (_this2.acl) {
              var permissions = Object(_helper__WEBPACK_IMPORTED_MODULE_1__["checkPermissions"])(['theme-update', 'theme-delete', 'theme-restore'], _this2.acl.permissions);
              var res = parseInt(row.status) === 4 && permissions['theme-restore'] ? "<a class=\"dropdown-item restore font-weight-bold\" href=\"#\" data-id=\"".concat(row.id, "\"  data-restore=\"").concat(row.url_restore, "\"><i class=\"la la-undo\"></i> Kh\xF4i ph\u1EE5c</a>") : '';
              var del = parseInt(row.status) === 10 && permissions['theme-delete'] ? "<a class=\"dropdown-item delete font-weight-bold\" href=\"#\" data-delete=\"".concat(row.url_delete, "\"><i class=\"la la-trash\"></i> X\xF3a</a>") : '';
              var edit = permissions['theme-update'] ? "<a class=\"dropdown-item font-weight-bold\" href=\"#\" data-edit=\"".concat(row.url_get_data_edit, "\" data-toggle=\"modal\" data-target=\"#modal-edit-theme\"><i class=\"la la-edit\"></i> C\u1EADp nh\u1EADt</a>") : '';
    ...
    value: function initModal() {
      ...
      var updateDropify = this.$updateThumbnail.dropify({
        messages: {
      ...
      this.$modalEditTheme.on('show.bs.modal', function (event) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url).then(function (_ref) {
          ...
          if (data.thumbnail) {
            updateDropify.settings.defaultFile = "".concat(data.thumbnail.base_url, "/").concat(data.thumbnail.absolute_url);
        ...
        Object(_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])([_this3.$updateName, _this3.$updateThumbnail]);

        _this3.$formUpdateTheme.trigger('reset');

        _this3.editTheme = null;
      });
      this.$modalCreateTheme.on('hide.bs.modal', function () {
        Object(_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])([_this3.$createName, _this3.$createThumbnail]);

        _this3.$formCreateTheme.trigger('reset');

        _this3.$formCreateTheme.find('.dropify-clear').click();
      });
    }
    /**
    ...
    value: function initUpdate() {
      ...
      this.$formUpdateTheme.submit(function (event) {
        event.preventDefault();

        if (_this4.editTheme) {
          Object(_helper__WEBPACK_IMPORTED_MODULE_1__["showBlock"])();
          var url = _this4.editTheme.url_update;
          axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, new FormData(event.target)).then(function (_ref2) {
            var data = _ref2.data;
            ...
            if (data.message) {
              ...
              _this4.$modalEditTheme.modal('hide');
            }
          }, function (err) {
            Object(_helper__WEBPACK_IMPORTED_MODULE_1__["hideBlock"])();
    ...
    value: function initCreate() {
      ...
      this.$formCreateTheme.submit(function (event) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, new FormData(event.target)).then(function (_ref3) {
          var data = _ref3.data;
          ...
          if (data.message) {
            ...
            _this5.$modalCreateTheme.modal('hide');
          }
        }, function (err) {
          Object(_helper__WEBPACK_IMPORTED_MODULE_1__["hideBlock"])();
          var status = err.response.status;
...
/***/ 19:
/*!**********************************************************************!*\
  !*** multi ./platform/ttct/resources/assets/js/pages/theme-index.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/ttct_cms/platform/ttct/resources/assets/js/pages/theme-index.js */"./platform/ttct/resources/assets/js/pages/theme-index.js");
