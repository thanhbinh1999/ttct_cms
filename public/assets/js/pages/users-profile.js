...
/***/ "./platform/user/resources/assets/js/pages/users-profile.js":
/*!******************************************************************!*\
  !*** ./platform/user/resources/assets/js/pages/users-profile.js ***!
  \******************************************************************/
/*! no exports provided */
...
function () {
  function UsersProfile() {
    _classCallCheck(this, UsersProfile);
  ...
  _createClass(UsersProfile, [{
    ...
    value: function initSubmit() {
      ...
      this.$formUpdateProfile.submit(function (event) {
        event.preventDefault(); // showBlock();

        Object(_ttct_resources_assets_js_pages_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])([_this.$firstName, _this.$lastName, _this.$email, _this.$dob, _this.$phone, _this.$address, _this.$gender, _this.$avatar]);
...
/***/ 32:
/*!************************************************************************!*\
  !*** multi ./platform/user/resources/assets/js/pages/users-profile.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/cms/platform/user/resources/assets/js/pages/users-profile.js */"./platform/user/resources/assets/js/pages/users-profile.js");
