...
/***/ "./platform/ttct/resources/assets/js/pages/tags-index.js":
/*!***************************************************************!*\
  !*** ./platform/ttct/resources/assets/js/pages/tags-index.js ***!
  \***************************************************************/
/*! no exports provided */
...
function () {
  function TagsIndex() {
    ...
    this.$createDescription = $('#create-description'); //update
  ...
  _createClass(TagsIndex, [{
    ...
    value: function initDatatable() {
      ...
      this.datatable = this.$tagTable.KTDatatable({
          ...
          source: {
            read: {
              ...
              params: {
                ...
                }), _defineProperty(_query, "type", 1), _query)
              },
        ...
        columns: [{
          ...
          textAlign: 'left',
          template: function template(row) {
            return "<strong>".concat(row.slug, "</strong>");
          }
        }, {
          field: 'description',
          title: 'MÔ TẢ',
          ...
          template: function template(row) {
            if (_this2.acl) {
              var permissions = Object(_helper__WEBPACK_IMPORTED_MODULE_1__["checkPermissions"])(['tag-update', 'tag-delete', 'tag-restore'], _this2.acl.permissions);
              var res = parseInt(row.status) === 4 && permissions['tag-restore'] ? "<a class=\"dropdown-item restore font-weight-bold\" href=\"#\" data-id=\"".concat(row.id, "\"  data-restore=\"").concat(row.url_restore, "\"><i class=\"la la-undo\"></i> Kh\xF4i ph\u1EE5c</a>") : '';
              var del = parseInt(row.status) === 10 && permissions['tag-delete'] ? "<a class=\"dropdown-item delete font-weight-bold\" href=\"#\" data-delete=\"".concat(row.url_delete, "\"><i class=\"la la-trash\"></i> X\xF3a</a>") : '';
              var edit = permissions['tag-update'] ? "<a class=\"dropdown-item font-weight-bold\" href=\"#\" data-edit=\"".concat(row.url_get_data_edit, "\" data-toggle=\"modal\" data-target=\"#modal-edit-tag\"><i class=\"la la-edit\"></i> C\u1EADp nh\u1EADt</a>") : '';
    ...
    value: function initModal() {
      ...
      this.$modalEditTag.on('show.bs.modal', function (event) {
        ...
        Object(_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])([_this3.$updateName]);

        _this3.$formUpdateTag.trigger('reset');
      });
      this.$modalCreateTag.on('hide.bs.modal', function () {
        Object(_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])([_this3.$createName]);

        _this3.$formCreateTag.trigger('reset');
      });
    }
    /**
    ...
    value: function initUpdate() {
      ...
      this.$formUpdateTag.submit(function (event) {
        event.preventDefault();

        if (_this4.editTag) {
          Object(_helper__WEBPACK_IMPORTED_MODULE_1__["showBlock"])();
          var url = _this4.editTag.url_update;
          axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, new FormData(event.target)).then(function (res) {
            ...
            _this4.$modalEditTag.modal('hide');
          }, function (err) {
            Object(_helper__WEBPACK_IMPORTED_MODULE_1__["hideBlock"])();
    ...
    value: function initCreate() {
      ...
      this.$formCreateTag.submit(function (event) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, new FormData(event.target)).then(function (res) {
          ...
          _this5.$modalCreateTag.modal('hide');
        }, function (err) {
          Object(_helper__WEBPACK_IMPORTED_MODULE_1__["hideBlock"])();
          var status = err.response.status;
...
/***/ 18:
/*!*********************************************************************!*\
  !*** multi ./platform/ttct/resources/assets/js/pages/tags-index.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/ttct_cms/platform/ttct/resources/assets/js/pages/tags-index.js */"./platform/ttct/resources/assets/js/pages/tags-index.js");
