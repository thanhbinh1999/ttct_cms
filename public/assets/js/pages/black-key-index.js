...
/***/ "./platform/comment/resources/assets/js/pages/black-key/black-key-index.js":
/*!*********************************************************************************!*\
  !*** ./platform/comment/resources/assets/js/pages/black-key/black-key-index.js ***!
  \*********************************************************************************/
/*! no exports provided */
...
/*#__PURE__*/
function () {
  function BlackKeyIndex() {
    _classCallCheck(this, BlackKeyIndex);
  ...
  _createClass(BlackKeyIndex, [{
    ...
    value: function initDatatable() {
      ...
      this.datatable = this.$blackKeyTable.KTDatatable({
        ...
        columns: [{
          ...
          textAlign: 'center',
          template: function template(row) {
            return "<strong>".concat(row.key, "</strong>");
          }
        }, {
          field: 'actions',
          title: '!!!',
          ...
          template: function template(row) {
            if (_this2.acl) {
              var permissions = Object(_ttct_resources_assets_js_pages_helper__WEBPACK_IMPORTED_MODULE_1__["checkPermissions"])(['black-key-delete'], _this2.acl.permissions);
              var del = permissions['black-key-delete'] ? "<a class=\"dropdown-item font-weight-bold delete-black-key\" href=\"#\" data-url-delete=\"".concat(row.url_delete, "\"><i class=\"la la-close\"></i>X\xF3a</a>") : '';
    ...
    value: function initCreate() {
      ...
      this.modalCreateBlackKey.on('hide.bs.modal', function () {
        _this3.$formCreateBlackKey.trigger('reset');

        Object(_ttct_resources_assets_js_pages_helper__WEBPACK_IMPORTED_MODULE_1__["removeError"])([_this3.$createKey]);
      });
      this.$formCreateBlackKey.submit(function (event) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, new FormData(event.target)).then(function (_ref) {
          ...
          setTimeout(function () {
            _this3.modalCreateBlackKey.modal('hide');
    ...
    value: function initDelete() {
      ...
      $(document).on('click', '.delete-black-key', function (event) {
        event.preventDefault();
...
/***/ 49:
/*!***************************************************************************************!*\
  !*** multi ./platform/comment/resources/assets/js/pages/black-key/black-key-index.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/cms/platform/comment/resources/assets/js/pages/black-key/black-key-index.js */"./platform/comment/resources/assets/js/pages/black-key/black-key-index.js");
