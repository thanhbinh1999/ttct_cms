...
/***/ "./platform/comment/resources/assets/js/pages/comment/comment-report-comment-by-author.js":
/*!************************************************************************************************!*\
  !*** ./platform/comment/resources/assets/js/pages/comment/comment-report-comment-by-author.js ***!
  \************************************************************************************************/
 ...
 */
var CommentReportCommentByAuthor =
/*#__PURE__*/
function () {
  function CommentReportCommentByAuthor() {
    _classCallCheck(this, CommentReportCommentByAuthor);
  ...
  _createClass(CommentReportCommentByAuthor, [{
    key: "init",
    value: function init() {
      this.initSelect2();
      this.initPickDate();
      ...
      this.datatable = this.datatable = this.$commentReportCommentByAuthorTable.KTDatatable({
        ...
        columns: [{
          ...
          template: function template(row) {
            return "<strong>".concat(row.author_email, "</strong>");
          }
        }, {
          field: 'total',
          ...
          textAlign: 'center',
          template: function template(row) {
            return "<strong>".concat(row.count_cmt, "</strong>");
          }
        }]
      });
  ...
  return CommentReportCommentByAuthor;
}();
...
/***/ 43:
/*!******************************************************************************************************!*\
  !*** multi ./platform/comment/resources/assets/js/pages/comment/comment-report-comment-by-author.js ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/cms/platform/comment/resources/assets/js/pages/comment/comment-report-comment-by-author.js */"./platform/comment/resources/assets/js/pages/comment/comment-report-comment-by-author.js");
