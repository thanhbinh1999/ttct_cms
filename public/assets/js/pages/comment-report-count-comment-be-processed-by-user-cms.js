...
/***/ "./platform/comment/resources/assets/js/pages/comment/comment-report-count-comment-be-processed-by-user-cms.js":
/*!*********************************************************************************************************************!*\
  !*** ./platform/comment/resources/assets/js/pages/comment/comment-report-count-comment-be-processed-by-user-cms.js ***!
  \*********************************************************************************************************************/
 ...
 */
var CommentReportCountCommentBeProcessedByUserCms =
/*#__PURE__*/
function () {
  function CommentReportCountCommentBeProcessedByUserCms() {
    _classCallCheck(this, CommentReportCountCommentBeProcessedByUserCms);
  ...
  _createClass(CommentReportCountCommentBeProcessedByUserCms, [{
    key: "init",
    value: function init() {
      this.initSelect2();
      this.initPickDate();
    ...
    value: function initDatatable() {
      ...
      this.datatable = this.$commentReportCommentBeProcessedByUserCmsTable.KTDatatable({
        ...
        columns: [{
          ...
          textAlign: 'center',
          template: function template(row) {
            return "<strong>".concat(row.publish.count.published, "</strong>");
          }
        }, {
          field: 'publish',
          title: 'ĐÃ DUYỆT',
          ...
          textAlign: 'center',
          template: function template(row) {
            return "<strong>".concat(row.verify.count.verified, "</strong>");
          }
        }, {
          field: 'deleted',
          title: 'ĐÃ XÓA',
          ...
          textAlign: 'center',
          template: function template(row) {
            return "<strong>".concat(row["delete"].count.deleted, "</strong>");
          }
        }, {
          field: 'total',
          title: 'TỔNG',
  ...
  return CommentReportCountCommentBeProcessedByUserCms;
}();
...
/***/ 41:
/*!***************************************************************************************************************************!*\
  !*** multi ./platform/comment/resources/assets/js/pages/comment/comment-report-count-comment-be-processed-by-user-cms.js ***!
  \***************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/cms/platform/comment/resources/assets/js/pages/comment/comment-report-count-comment-be-processed-by-user-cms.js */"./platform/comment/resources/assets/js/pages/comment/comment-report-count-comment-be-processed-by-user-cms.js");
