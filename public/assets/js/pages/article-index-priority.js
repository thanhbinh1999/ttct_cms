...
/***/ "./platform/ttct/resources/assets/js/pages/article-index-priority.js":
/*!***************************************************************************!*\
  !*** ./platform/ttct/resources/assets/js/pages/article-index-priority.js ***!
  \***************************************************************************/
/*! no exports provided */
...
var ArticleIndexPriority =
/*#__PURE__*/
function () {
  function ArticleIndexPriority() {
    _classCallCheck(this, ArticleIndexPriority);
  ...
  _createClass(ArticleIndexPriority, [{
    key: "init",
    value: function init() {
      this.getData();
      this.initSelect2();
          ...
          data: function data(params) {
            return {
              ...
              page: params.page,
                ...
                return JSON.stringify(_this.selectedArticles.map(function (item) {
                  return item.id;
                }));
              }
            };
          ...
          processResults: function processResults(data) {
            return {
              results: $.map(data.data, function (item) {
                return {
                  text: "<strong>".concat(item.title, "</strong>"),
                  id: item.id,
    ...
    value: function initAdd() {
      ...
      this.$addArticle.click(function (event) {
        event.preventDefault();

        if (_this2.$selectArticle.select2('data').length === 0) {
          toastr.info('Chưa chọn bài viết nào');
          return false;
        }

        var articles = _this2.$selectArticle.select2('data').map(function (item) {
          return {
            id: item.id,
            title: item.title
          };
        ...
        _this2.selectedArticles = _this2.selectedArticles.concat(articles);

        _this2.renderSort();

        _this2.$selectArticle.val(null).trigger('change');
      });
    }
  }, {
    key: "initDelete",
    value: function initDelete() {
      ...
      $(document).on('click', '.delete-item', function (event) {
        ...
        swal.fire({
          ...
          if (result.value) {
            _this3.selectedArticles = _this3.selectedArticles.filter(function (item) {
    ...
    value: function renderSort() {
      ...
      var html = this.selectedArticles.reduce(function (c, n) {
        return c + "\n                    <div class=\"dd-item dd3-item\" data-id=\"".concat(n.id, "\" style=\"cursor: pointer\">\n                            <div class=\"dd-handle dd3-handle\"></div>\n                            <div class=\"dd3-content\">\n                                <div style=\"display: flex;justify-content: left\">\n                                    <span style=\"font-weight: 600;font-size:15px; flex: 3;\" title=\"").concat(n.title, "\"> ").concat(n.title.length > 100 ? n.title.slice(0, 100) + '...' : n.title, "</span>\n                                    <div class=\"btn btn-danger btn-sm delete-item btn-icon\" data-id=\"").concat(n.id, "\" style=\"cursor: pointer;margin-top: 5px\">\n                                       <i class=\"la la-trash\"></i>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>");
      }, '');
      this.$sortArticleContainer.html(html);
      this.sortable = sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"].create(this.$sortArticleContainer[0], {
        onSort: function onSort() {
          var data = _this4.sortable.toArray();

          var tmp = [];
          data.forEach(function (item) {
            for (var i = 0; i < _this4.selectedArticles.length; i++) {
              if (parseInt(_this4.selectedArticles[i].id) === parseInt(item)) {
                tmp.push({
                  id: _this4.selectedArticles[i].id,
                  title: _this4.selectedArticles[i].title
                });
                break;
              }
            }
          });
          _this4.selectedArticles = tmp;
        }
      });
    }
  }, {
    ...
    value: function initSave() {
      ...
      this.$save.click(function (event) {
        event.preventDefault();
        Object(_helper__WEBPACK_IMPORTED_MODULE_2__["showBlock"])();

        if (_this5.selectedArticles.length < 4) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(url, {
          articles: JSON.stringify(_this5.selectedArticles)
        }).then(function (_ref) {
          var data = _ref.data;
    ...
    value: function getData() {
      ...
      Object(_helper__WEBPACK_IMPORTED_MODULE_2__["showBlock"])();
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.$sortArticleContainer.data('url')).then(function (_ref2) {
        var data = _ref2.data;
        _this6.selectedArticles = data;
        ...
        _this6.$save.prop('disabled', true);
      });
    }
  }]);

  return ArticleIndexPriority;
}();
...
/***/ 11:
/*!*********************************************************************************!*\
  !*** multi ./platform/ttct/resources/assets/js/pages/article-index-priority.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/ttct_cms/platform/ttct/resources/assets/js/pages/article-index-priority.js */"./platform/ttct/resources/assets/js/pages/article-index-priority.js");
