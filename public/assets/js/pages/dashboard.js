...
/***/ "./platform/ttct/resources/assets/js/pages/dashboard.js":
/*!**************************************************************!*\
  !*** ./platform/ttct/resources/assets/js/pages/dashboard.js ***!
  \**************************************************************/
/*! no exports provided */
...
function () {
  ...
  _createClass(Dashboard, [{
    ...
    key: "randomByte",
    value: function randomByte() {
      return this.randomNumber(0, 255);
    }
  }, {
    key: "randomPercent",
    value: function randomPercent() {
      return (this.randomNumber(50, 100) * 0.01).toFixed(2);
    }
  }, {
    key: "randomRgba",
    value: function randomRgba() {
      return "rgba(".concat([this.randomByte(), this.randomByte(), this.randomByte(), this.randomPercent()].join(','), ")");
    }
  }, {
    key: "initDatatable",
    value: function initDatatable() {
      ...
      this.datatableDraft = this.$dashboardDraftTable.KTDatatable({
        ...
        columns: [{
          ...
          textAlign: 'left',
          template: function template(row) {
            return row.created_at ? "<strong>".concat(row.created_at, "</strong>") : 'N/A';
          }
        }]
      });
      this.$dashboardDraftTable.on('kt-datatable--on-init', function () {
      ...
      this.datatablePublished.on('kt-datatable--on-init', function () {
        $('.kt-datatable__table').height(460);
        $('.ps--active-x').height(440);
      });
    }
  }, {
    key: "initGetDataAnalytic",
    value: function initGetDataAnalytic() {
      var _this2 = this;

      var users = this.$dashboardArticleByUserTable.data('users');
      var ids = users.map(function (item) {
        return item.id;
      });
      var url = $('#kt_content').data('url');
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, {
        ...
        _this2.renderCategoryChart(data.categories);

        _this2.renderTopical(data.topicals);

        _this2.renderTheme(data.themes);

        _this2.renderArticleCreateLast7Days(data.article_created_last_7_days);
        ...
        _this2.initTableUser(users);
      });
    }
  }, {
    key: "renderCategoryChart",
    value: function renderCategoryChart(data) {
      var _this3 = this;

      var color = data.map(function (item) {
        return _this3.randomRgba();
      });
    ...
    key: "renderTopical",
    value: function renderTopical(data) {
      var _this4 = this;

      var colors = data.map(function (item) {
        return _this4.randomRgba();
      });
    ...
    key: "renderTheme",
    value: function renderTheme(data) {
      var _this5 = this;

      var colors = data.map(function (item) {
        return _this5.randomRgba();
      });
    ...
    key: "renderArticleCreateLast7Days",
    value: function renderArticleCreateLast7Days(data) {
      var _this6 = this;

      var colors = Object.keys(data).map(function () {
        return _this6.randomRgba();
      });
    ...
    key: "initTableUser",
    value: function initTableUser(data) {
      this.datatableUser = this.$dashboardArticleByUserTable.KTDatatable({
        ...
        columns: [{
          ...
          textAlign: 'left',
          template: function template(row) {
            return "<strong>".concat(row.first_name ? row.first_name : '', " ").concat(row.last_name, "</strong>");
          }
        }, {
          field: 'username',
          title: 'TÊN ĐĂNG NHẬP',
          ...
          textAlign: 'center',
          template: function template(row) {
            return "<strong>".concat(row.count, "</strong>");
          }
        }]
      });
    }
...
/***/ 12:
/*!********************************************************************!*\
  !*** multi ./platform/ttct/resources/assets/js/pages/dashboard.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/ttct_cms/platform/ttct/resources/assets/js/pages/dashboard.js */"./platform/ttct/resources/assets/js/pages/dashboard.js");
