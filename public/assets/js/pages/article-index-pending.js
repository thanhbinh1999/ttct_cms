...
/***/ "./platform/ttct/resources/assets/js/pages/article-index-pending.js":
/*!**************************************************************************!*\
  !*** ./platform/ttct/resources/assets/js/pages/article-index-pending.js ***!
  \**************************************************************************/
/*! no exports provided */
...
var ArticleIndexPending =
/*#__PURE__*/
function () {
  function ArticleIndexPending() {
    _classCallCheck(this, ArticleIndexPending);
  ...
  _createClass(ArticleIndexPending, [{
    key: "init",
    value: function init() {
      this.initGetAcl();
      this.initModal();
    ...
    value: function initDatatable() {
      ...
      var columns = [{
        ...
        template: function template(row) {
          if (_this4.acl) {
            var permissions = Object(_helper__WEBPACK_IMPORTED_MODULE_1__["checkPermissions"])(['article-publish'], _this4.acl.permissions);
            var pub = permissions['article-publish'] ? "<a class=\"dropdown-item pub-now font-weight-bold\" href=\"#\" data-status-public=\"".concat(row.status_pub, "\" data-public=\"").concat(row.url_pub, "\"><i class=\"la la-file-text\"></i> Xu\u1EA5t b\u1EA3n ngay</a>") : "";
          ...
          source: {
            read: {
              ...
              params: {
                ...
                }), _defineProperty(_query, "published_at_gt_n", 1), _query)
              },
    ...
    value: function initPublish() {
      ...
      $(document).on('click', '.pub-now', function (event) {
        event.preventDefault();
        var url = $(event.currentTarget).data('public');
        var status = $(event.currentTarget).data('status-public');
        swal.fire({
          ...
          data: function data(params) {
            return {
              ...
              page: params.page,
                ...
                return "[1,".concat(_this7.$userInfo.data('role-id'), "]");
              }
            };
          },
          ...
          data: function data(params) {
            return {
              ...
              role_of_user: function role_of_user() {
                return _this8.$userInfo.data('role-id');
              }
            };
          },
          processResults: function processResults(data) {
...
/***/ 0:
/*!********************************************************************************!*\
  !*** multi ./platform/ttct/resources/assets/js/pages/article-index-pending.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/ttct_cms/platform/ttct/resources/assets/js/pages/article-index-pending.js */"./platform/ttct/resources/assets/js/pages/article-index-pending.js");
