        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Bình luận bị báo cáo</a>
                </div>
            </div>
            <div class="kt-subheader__toolbar" style="display: none">
                <div class="kt-subheader__wrapper">
                    <button class="btn btn-success" id="bulk-ignore" data-url="{{ route('comments.update_report_comment') }}"><i class="la la-check"></i> Bulk bỏ qua</button>
                    <button class="btn btn-warning btn-md" id="bulk-delete" data-url="{{ route('comments.update_report_comment') }}"><i class="la la-close"></i>Bulk xóa</button>
                </div>
            </div>
        </div>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title text-uppercase">Bình luận bị báo cáo</h3>
                    </div>
                </div>
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-datatable" id="comment-reported-table" data-url="{{ route('comments.datatable') }}"></div>
                </div>
            </div>
        </div>
    </div>
...
@stop
@push('page-js')
    <script src="{{ asset('assets/js/pages/comment-reported.js') }}" type="text/javascript"></script>
@endpush
