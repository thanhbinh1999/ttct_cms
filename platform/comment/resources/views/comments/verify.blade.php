        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Bình luận chờ duyệt</a>
                </div>
            </div>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title text-uppercase">Bình luận chờ duyệt</h3>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-2 kt-margin-b-20-tablet-and-mobile">
                                            <div class="kt-form__group kt-form__group--inline">
                                                ...
                                                <div class="kt-form__control">
                                                    <input class="form-control" id="search-from" value="{{  date('d/m/Y', strtotime('-7 Days') )   }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2 kt-margin-b-20-tablet-and-mobile">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-datatable" id="comment-verify-table" data-url="{{ route('comments.datatable') }}"></div>
                </div>
            </div>
        </div>
    </div>
...
@stop
@push('page-js')
    <script src="{{ asset('assets/js/pages/comment-verify.js') }}" type="text/javascript"></script>
@endpush
