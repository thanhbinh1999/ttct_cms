        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Thống kê bài viết có bình luận nhiều</a>
                </div>
            </div>
        </div>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title text-uppercase">Thống kê bài viết có bình luận nhiều</h3>
                    </div>
                </div>
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-datatable" id="comment-report-most-comment-table" data-url="{{ route('comments.most_count_comment') }}"></div>
                </div>
            </div>
        </div>
    </div>
@stop
@push('page-js')
    <script src="{{ asset('assets/js/pages/comment-report-most-comment.js') }}" type="text/javascript"></script>
@endpush
