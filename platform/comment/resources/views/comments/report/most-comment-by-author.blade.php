        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-datatable" id="comment-report-comment-by-author-table" data-url="{{ route('comments.most_comment_by_author') }}"></div>
                </div>
            </div>
        </div>
    </div>
@stop
@push('page-js')
    <script src="{{ asset('assets/js/pages/comment-report-comment-by-author.js') }}" type="text/javascript"></script>
@endpush
