        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            <div class="kt-portlet kt-portlet--mobile">
                                    ...
                                    <div class="row align-items-left">
                                        <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                            <div class="form-group row" style="margin-bottom: 0px">
                                                <label for="search-to" class="col-form-label col-3">Sắp xếp theo</label>
                                                <div class="col-8">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-datatable" id="comment-report-total-comment-table" data-url="{{ route('comments.most_count_comment') }}"></div>
                </div>
            </div>
        </div>
    </div>
@stop
@push('page-js')
    <script src="{{ asset('assets/js/pages/comment-report-total-comment.js') }}" type="text/javascript"></script>
@endpush
