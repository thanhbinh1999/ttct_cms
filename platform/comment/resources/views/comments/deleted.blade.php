        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Bình luận đã xóa</a>
                </div>
            </div>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title text-uppercase">Bình luận đã xóa</h3>
                    </div>
                </div>
                            ...
                            <div class="col-11">
                                ...
                                <div class="col-xl-12 mt-5">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                            <div class="form-group row">
                                                <label for="search-to" class="col-form-label col-5">Được xóa bởi</label>
                                                <div class="col-7">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-datatable" id="comment-delete-table" data-url="{{ route('comments.datatable') }}"></div>
                </div>
            </div>
        </div>
    </div>
...
@stop
@push('page-js')
    <script src="{{ asset('assets/js/pages/comment-deleted.js') }}" type="text/javascript"></script>
@endpush
