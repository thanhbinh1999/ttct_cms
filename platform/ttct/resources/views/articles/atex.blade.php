        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Kho báo giấy </a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="" class="kt-subheader__breadcrumbs-link">Bài viết chưa xử lý </a>
                </div>
            </div>
        </div>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title text-uppercase">Bài viết chưa xử lý </h3>
                    </div>
                </div>
                           ...
                           <div class="col-11">
                               <div class="col-xl-12">
                                   <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                          <div  style="margin-top: 20px" class="kt-form__group">
                                            <input type="text" class="form-control search" placeholder="Ngày bắt đầu" id="startDate">
                                          </div>
                                        </div>
                                        <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                          <div  style="margin-top: 20px" class="kt-form__group">
                                            <input type="text" class="form-control search" placeholder="Ngày kết thúc" id="endDate">
                                          </div>
                                        </div>
                                        <div class="col-md-3" style="margin-top: 20px">
                                          <button class="btn btn-brand btn-icon " id="search-btn">
