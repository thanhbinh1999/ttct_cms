        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="" class="kt-subheader__breadcrumbs-link">Bài viết đã gỡ</a>
                </div>
            </div>
        </div>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title text-uppercase">Bài viết đã gỡ</h3>
                    </div>
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-datatable" id="article-table" data-update-article-editor="{{ $listUrl['update-article-editor'] }}" data-url="{{ $listUrl['datatable'] }}" data-edit="{{ route('ttct.articles.edit',1) }}"></div>
                </div>
            </div>
        </div>
    </div>
...
@stop
@push('page-js')
    <script src="{{ asset('assets/js/pages/article-index-take-down.js') }}" type="text/javascript"></script>
@endpush
