        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Bài viết</a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                            ...
                            <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                                ...
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group">
                                            <label for="update-excerpt">Đoạn trích dẫn</label>
                                            <textarea rows="7" class="form-control" placeholder="Nhập đoạn trích dẫn" id="update-excerpt" name="excerpt"></textarea>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="kt-portlet__body kt-portlet__body--fit">
                                <div class="kt-portlet__body">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="update-thumbnail" name="thumbnail" data-height="350" accept="image/png,image/jpg,image/jpeg">
                                    ...
                                    <div class="form-group">
                                        <label for="update-categories">Chọn chủ đề</label>
                                        <select class="form-control" id="update-categories" name="categories"></select>
                                    </div>
                                    <div class="form-group">
                                        <label for="update-tags">Chọn tag</label>
...
@endpush
@push('page-js')
    <script src="{{ asset('assets/js/pages/topical/edit-article.js') }}" type="text/javascript"></script>
@endpush
