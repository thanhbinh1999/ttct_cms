        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="" class="kt-subheader__breadcrumbs-link">Cập nhật profile</a>
                </div>
            </div>
        </div>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Cập nhật profile</h3>
                    </div>
                </div>
                <div class="kt-portlet__body">
                    <form id="form-update-profile" class="kt-form" action="{{ route('users.update_profile') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="kt-portlet__body">
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Họ & tên đệm" id="first_name" name="first_name" value="{{ auth()->user()->first_name }}">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="last_name" class="kt-font-bold">Tên</label>
                                        <input type="text" class="form-control" placeholder="Tên" id="last_name" name="last_name" value="{{ auth()->user()->last_name }}">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="email" class="kt-font-bold">Email</label>
                                        <input type="text" class="form-control"  placeholder="Email" id="email" name="email" value="{{ auth()->user()->email }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="dob" name="dob" placeholder="Enter email" value="{{ date('d/m/Y',strtotime(auth()->user()->dob)) }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="phone" class="kt-font-bold">SĐT</label>
                                        <input type="text" class="form-control" name="phone" id="phone" placeholder="SĐT" value="{{ auth()->user()->phone }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address" placeholder="Địa chỉ" value="{{ auth()->user()->address }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="gender" id="gender">
                                            ...
                                            <option @if(auth()->user()->gender == 2){{ 'selected' }}@endif value="2">Nữ</option>
                                            <option @if(auth()->user()->gender == 3){{ 'selected' }}@endif value="10">Nửa nạc nửa mỡ</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="avatar" id="avatar" data-default-file="{{ auth_avatar() }}">
                            </div>
                        </div>
...
@endpush
@push('page-js')
    <script src="{{ asset('assets/js/pages/users-profile.js') }}" type="text/javascript"></script>
@endpush
